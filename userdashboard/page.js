			...
			<div style={{ marginTop: "20px" }}>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
					{registeredUser?.courses.map((course) => (
						<button key={`${registeredUser.id}-${course.course_name}`} onClick={() => handleLessons(course)} style={{ width: "fit-content", cursor: "pointer", padding: "12px 24px", backgroundColor: "dodgerblue", borderRadius: "13px", border: "none", color: "white", fontWeight: "bold" }}>
			...
			{editUser && (
				<div style={{ position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", backgroundColor: "rgba(0, 0, 0, 0.62)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 999 }}>
					<div style={{ background: "white", padding: "20px", borderRadius: "8px", minWidth: "300px", boxShadow: "0 2px 12px black" }}>
						...
						<br />
						<button onClick={handleEditSubmit} style={{ backgroundColor: "blue", color: "white", border: "none", padding: "6px 12px", borderRadius: "4px", cursor: "pointer", marginRight: "8px" }}>
							Save
						</button>
