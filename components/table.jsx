									...
									{(onEdit || onDelete) && (
										<TableCell>
											<div style={{ display: "flex", gap: "10px" }}>
												...
												{onDelete && (
													<button onClick={() => onDelete(user.id)} style={{ backgroundColor: "red", color: "white", border: "none", padding: "6px 12px", borderRadius: "4px", cursor: "pointer" }}>
														Delete
													</button>
												)}
												{onDeleteCourse && (
													<button onClick={() => onDeleteCourse(user.id, course.course_name)} style={{ backgroundColor: "purple", color: "white", border: "none", padding: "6px 12px", borderRadius: "4px", cursor: "pointer" }}>
														Delete Course
													</button>
												)}
												{onAdd && (
									...
									{(onEdit || onDeleteCourse || onAdd) && (
										<TableCell>
											<div style={{ display: "flex", gap: "10px" }}>
												...
												{onDeleteCourse && (
													<button onClick={() => onDeleteCourse(user.id, course.course_name)} style={{ backgroundColor: "red", color: "white", border: "none", padding: "6px 12px", borderRadius: "4px", cursor: "pointer" }}>
														Delete Course
													</button>
												)}
												{onAdd && (
